...
export default function Header() {
  ...
  return (
    <header className="w-full bg-verde-escuro h-[60px] sticky top-0 z-50">
      <div className="max-w-site mx-auto h-full px-[200px] flex items-center justify-between">
        ...
        <nav className="flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 bg-laranja text-bege text-base px-3 py-1.5 rounded-[5px] hover:bg-laranja/90 transition-colors whitespace-nowrap"
          >
            Agendar
          </a>
