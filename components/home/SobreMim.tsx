...
export default function SobreMim() {
  return (
    <section id="sobre" className="relative overflow-hidden bg-bege-light py-20 md:py-28 scroll-mt-[88px]">
      <div className="max-w-site mx-auto px-6 md:px-10 lg:px-16 xl:px-24">
        {/* Título editorial à esquerda */}
        <div className="relative">
          <span className="inline-flex items-center gap-2 font-sans font-bold text-eyebrow uppercase text-laranja">
            <Sparkle size={12} />
            Sobre Mim
          </span>
          <h2
            data-anim="lines"
            className="relative z-10 font-display font-normal text-display-xl text-verde-escuro px-2 -mx-2 mt-3"
          >
            Isa Pupo
          </h2>
          <Sparkle
            size={18}
            className="absolute top-2 left-[min(52vw,560px)] text-rosa animate-twinkle hidden md:block"
          />
        </div>
        ...
        <div className="mt-10 md:mt-16 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-0 items-start">
          ...
          <div className="relative lg:col-span-5 lg:pr-10">
            <div
              ...
              data-speed="0.93"
            >
              <Blob variant={2} color="text-bege" className="w-full h-auto" />
            </div>
            <div
              data-anim="image"
          ...
          <div className="lg:col-span-7 lg:pl-8 xl:pl-12">
            <div className="text-marrom space-y-5">
              <p
                data-anim="fade-up"
              ...
              <div className="space-y-4 text-[17px] md:text-[18px] leading-[1.55] max-w-[600px]" data-anim="fade-up">
                <p>
